...
(define (problem fully-connected-04)
  (:domain locality)
  (:objects
   ...
   ;50 data blocks to be scattered.
    ...
    block-40 block-41 block-42 block-43 block-44 block-45 block-46 block-47 block-48 block-49 - data-block
    count-0 - zero
    ...
    count-41 count-42 count-43 count-44 count-45 count-46 count-47 count-48 count-49 count-50 - non-zero
)
(:init
    (= (total-cost) 0)
    (in block-0 node-A)
    ...
    (connection node-F node-G)
    (connection node-G node-A)
    (connection node-G node-B)
    (connection node-G node-C)
    (connection node-G node-D)
    (connection node-G node-E)
    (connection node-G node-F)
    ...
    (sent node-F node-G count-0)
    (sent node-G node-A count-0)
    (sent node-G node-B count-0)
    (sent node-G node-C count-0)
    (sent node-G node-D count-0)
    (sent node-G node-E count-0)
    (sent node-G node-F count-0)
    ...
    (= (segment-bandwidth node-A node-F) 100)
    (= (segment-bandwidth node-A node-G) 200)
    ...
    (= (segment-bandwidth node-B node-G) 100)
    ...
    (= (segment-bandwidth node-C node-G) 100)
    ...
    (= (segment-bandwidth node-D node-G) 100)
    ...
    (= (segment-bandwidth node-E node-G) 100)
    (= (segment-bandwidth node-F node-A) 100)
    ...
    (= (segment-bandwidth node-F node-G) 200)
    (= (segment-bandwidth node-G node-A) 200)
    (= (segment-bandwidth node-G node-B) 100)
    (= (segment-bandwidth node-G node-C) 100)
    (= (segment-bandwidth node-G node-D) 100)
    (= (segment-bandwidth node-G node-E) 100)
    (= (segment-bandwidth node-G node-F) 200)
    ...
    (= (block-relative-bandwidth count-41) 0.3)
    (= (block-relative-bandwidth count-42) 0.3)
    (= (block-relative-bandwidth count-43) 0.3)
    (= (block-relative-bandwidth count-44) 0.3)
    (= (block-relative-bandwidth count-45) 0.3)
    (= (block-relative-bandwidth count-46) 0.3)
    (= (block-relative-bandwidth count-47) 0.3)
    (= (block-relative-bandwidth count-48) 0.3)
    (= (block-relative-bandwidth count-49) 0.3)
    (= (block-relative-bandwidth count-50) 0.3)
)
 (:goal (and
    (in block-0 node-A)
    (in block-1 node-A)
